        ...
        public static List<PortFolioDetails> _portFolioDetails = new List<PortFolioDetails>()
            {
                new PortFolioDetails{
                    ...
                    {
                        new MutualFundDetails{MutualFundName = "HINDUSTAN", MutualFundUnits=44},
                        new MutualFundDetails{MutualFundName = "ADANI", MutualFundUnits=66},
                        new MutualFundDetails{MutualFundName = "SBI", MutualFundUnits=424},
                        new MutualFundDetails{MutualFundName = "ICICI", MutualFundUnits=656}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 7, StockName = "NESTLE"},
                        new StockDetails{StockCount = 450, StockName = "ONGC"},
                        new StockDetails{StockCount = 100, StockName = "TATA"},
                        new StockDetails{StockCount = 60, StockName = "AXIS"},
                        new StockDetails{StockCount = 15, StockName = "TITAN"}
                    }
                },
                new PortFolioDetails
                {
                    ...
                    MutualFundList = new List<MutualFundDetails>()
                    {
                        new MutualFundDetails{MutualFundName = "ONGC", MutualFundUnits=34},
                        new MutualFundDetails{MutualFundName = "ADANI", MutualFundUnits=566},
                        new MutualFundDetails{MutualFundName = "SBI", MutualFundUnits=34}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 240, StockName = "ONGC"},
                        new StockDetails{StockCount = 46, StockName = "TITAN"},
                        new StockDetails{StockCount = 10, StockName = "HDFC"},
                        new StockDetails{StockCount = 20, StockName = "LIC"},
                        new StockDetails{StockCount = 300, StockName = "TATA"}
                    }
                },
                new PortFolioDetails
                {
                    ...
                    MutualFundList = new List<MutualFundDetails>()
                    {
                        new MutualFundDetails{MutualFundName = "ZOMATO", MutualFundUnits=8},
                        new MutualFundDetails{MutualFundName = "ICICI", MutualFundUnits=6},
                        new MutualFundDetails{MutualFundName = "HINDUSTAN", MutualFundUnits=6}
                    },
                    StockList = new List<StockDetails>()
                    {
                        new StockDetails{StockCount = 20, StockName = "TATA"},
                        new StockDetails{StockCount = 34, StockName = "ONGC"},
                        new StockDetails{StockCount = 12, StockName = "NESTLE"},
                        new StockDetails{StockCount = 20, StockName = "RELIANCE"},
                        new StockDetails{StockCount = 300, StockName = "INDIANOIL"}
                    }
                }
